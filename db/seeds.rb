...
5.times do |i|
    ...
    Job.create(company_id: "#{i+5}", title: "Manager", level: "Junior", sector: "Sales",
...
5.times do |i|
    ...
    Job.create(company_id: "#{i+10}", title: "Director", level: "Senior", sector: "Technology",
...
5.times do |i|
    ...
    Job.create(company_id: "#{i+20}", title: "Manager", level: "Junior", sector: "Sales",
               description: "A description.", education_requirement: "Master's")
end
...
5.times do |i|
    ...
    Job.create(company_id: "#{i+25}", title: "Director", level: "Senior", sector: "Technology",
               description: "A description.", education_requirement: "Doctorate")
end
...
5.times do |i|
    ...
    Job.create(company_id: "#{i+35}", title: "Manager", level: "Junior", sector: "Sales",
               description: "A description.", education_requirement: "Master's")
end
...
5.times do |i|
    ...
    Job.create(company_id: "#{i+40}", title: "Director", level: "Senior", sector: "Technology",
               description: "A description.", education_requirement: "Doctorate")
end
...
5.times do |i|
    ...
    Job.create(company_id: "#{i+50}", title: "Manager", level: "Junior", sector: "Sales",
               description: "A description.", education_requirement: "Master's")
end
...
5.times do |i|
    ...
    Job.create(company_id: "#{i+55}", title: "Director", level: "Senior", sector: "Technology",
               description: "A description.", education_requirement: "Doctorate")
end
...
5.times do |i|
    ...
    Job.create(company_id: "#{i+65}", title: "Manager", level: "Junior", sector: "Sales",
               description: "A description.", education_requirement: "Master's")
end
...
5.times do |i|
    ...
    Job.create(company_id: "#{i+70}", title: "Director", level: "Senior", sector: "Technology",
               description: "A description.", education_requirement: "Doctorate")
end
...
5.times do |i|
    ...
    Job.create(company_id: "#{i+80}", title: "Manager", level: "Junior", sector: "Sales",
               description: "A description.", education_requirement: "Master's")
end
...
5.times do |i|
    ...
    Job.create(company_id: "#{i+85}", title: "Director", level: "Senior", sector: "Technology",
               description: "A description.", education_requirement: "Doctorate")
end